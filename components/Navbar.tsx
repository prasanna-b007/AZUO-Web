  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex flex-col items-center pointer-events-none pt-4 px-4 sm:pt-6">
      <motion.div
        ...
        className={cn(
          "pointer-events-auto w-full max-w-5xl transition-all duration-500 ease-in-out border overflow-hidden",
          scrolled 
            ? "bg-black/60 backdrop-blur-xl rounded-full px-6 py-2 shadow-[0_8px_32px_0_rgba(0,0,0,0.8)] border-white/20" 
            : "bg-white/5 backdrop-blur-md rounded-[2rem] px-8 py-4 border-white/10"
        )}
      >
          ...
          <Link href="/" className="flex items-center gap-3 group pointer-events-auto">
            ...
            >
              <Image
                ...
                alt="AZUO Logo"
                fill
                className="object-contain drop-shadow-[0_0_8px_rgba(14,165,233,0.5)]"
              />
            </motion.div>
